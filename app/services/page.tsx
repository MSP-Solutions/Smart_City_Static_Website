...
const services = [
  {
    ...
    icon: BookOpen,
    desc: "Comprehensive Japanese language training from basic to advanced levels (N5 to N1).",
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
            {services.map((service, i) => (
              <Link
                key={i}
                href={service.href}
                className="card-hover bg-white p-12 flex flex-col sm:flex-row gap-10 items-start group border border-gray-100 relative overflow-hidden"
              >
